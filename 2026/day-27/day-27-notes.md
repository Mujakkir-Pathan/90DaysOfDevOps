...
1. **90 Days of DevOps** — 
    ...
    * [90 Days of DevOps Repository](https://github.com/Afroz-J-Shaikh/90DaysOfDevOps/tree/master/2026)

2. **Shell Scripts** — a dedicated repo for all your shell scripting work

    * [Shell Scripts Repository](https://github.com/Afroz-J-Shaikh/MyShellSrcipts)

3. **Python Scripts** — a dedicated repo for your Python projects

    * [Python Repository](https://github.com/Afroz-J-Shaikh/python-for-devops)

4. **DevOps Notes** — a repo for your learning notes, cheat sheets, and references

    * [DevOps Notes](https://github.com/Afroz-J-Shaikh/DevOps-Notes)
...
* Before
    ...
    ![snapshot](images/before1.png)
    ![snapshot](images/before2.png)
